...
class PaisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pais" do
    assert_difference('Pais.count') do
      post paises_url, params: { pais: { abreviacion: @pais.abreviacion, nombre: @pais.nombre } }
    end
  ...
  test "should update pais" do
    patch pais_url(@pais), params: { pais: { abreviacion: @pais.abreviacion, nombre: @pais.nombre } }
