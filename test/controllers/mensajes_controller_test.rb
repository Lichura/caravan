...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post mensajes_url, params: { mensaje: { email: @mensaje.email, empresa: @mensaje.empresa, nombre: @mensaje.nombre, telefono: @mensaje.telefono, texto: @mensaje.texto } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { email: @mensaje.email, empresa: @mensaje.empresa, nombre: @mensaje.nombre, telefono: @mensaje.telefono, texto: @mensaje.texto } }
