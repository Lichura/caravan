...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { activo: @producto.activo, descripcion: @producto.descripcion, familia_id: @producto.familia_id, image: @producto.image, nombre: @producto.nombre, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { activo: @producto.activo, descripcion: @producto.descripcion, familia_id: @producto.familia_id, image: @producto.image, nombre: @producto.nombre, precio: @producto.precio } }
