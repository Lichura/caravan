...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { bonificacion: @factura.bonificacion, cae: @factura.cae, control: @factura.control, cuit: @factura.cuit, fecha: @factura.fecha, iibb: @factura.iibb, iva: @factura.iva, neto: @factura.neto, numero: @factura.numero, pto_venta: @factura.pto_venta, subtotal: @factura.subtotal, tipo: @factura.tipo, total: @factura.total, vencimiento_cae: @factura.vencimiento_cae, vendedor: @factura.vendedor } }
    end
