...
class ProvinciasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provincia" do
    assert_difference('Provincia.count') do
      post provincias_url, params: { provincia: { nombre: @provincia.nombre, nombre_corto: @provincia.nombre_corto, pais_id: @provincia.pais_id } }
    end
  ...
  test "should update provincia" do
    patch provincia_url(@provincia), params: { provincia: { nombre: @provincia.nombre, nombre_corto: @provincia.nombre_corto, pais_id: @provincia.pais_id } }
