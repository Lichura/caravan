...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { distribuidor_id: @pago.distribuidor_id, estado: @pago.estado, medioDePago: @pago.medioDePago, monto: @pago.monto, numero: @pago.numero } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { distribuidor_id: @pago.distribuidor_id, estado: @pago.estado, medioDePago: @pago.medioDePago, monto: @pago.monto, numero: @pago.numero } }
