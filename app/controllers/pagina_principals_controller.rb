class PaginaPrincipalsController < ApplicationController
  ...
  def index
    ...
    @prueba = Senasa.new
    @numeros = @prueba.verificar_cantidad_de_letras("JA20")
  ...
  private
    ...
    def pagina_principal_params
      params.require(:pagina_principal).permit(:imagen_principal, :nosotros_texto, :pagina_principal_productos_attributes => [:id, :_destroy, :nombre, :descripcion, :imagen])
    end
end
